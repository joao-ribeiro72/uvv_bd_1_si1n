...
/* Criação da chave estrangeira que referencia a tupla "cpf_gerente" de "departamento" à tupla "cpf" de "funcionario" */
...
/* Criação da chave estrangeira que referencia a tupla "cpf_funcionario" de "dependente" à tupla "cpf" de "funcionario" */
...
/* Criação da chave estrangeira que referencia a tupla "cpf_funcionario" de "trabalha_em" à tupla "cpf" de "funcionario" */
...
/* Criação da chave estrangeira que referencia a tupla "cpf_supervisor" de "funcionario" à tupla "cpf" de "funcionario", um auto-relacionamento */
...
/* Criação da chave estrangeira que referencia a tupla "numero_departamento" de "localizacoes_departamento" à tupla "numero_departamento" de "departamento" */
...
/* Criação da chave estrangeira que referencia a tupla "numero_departamento" de "projeto" à tupla "numero_departamento" de "departamento" */
...
/* Criação da chave estrangeira que referencia a tupla "numero_departamento" de "funcionario" à tupla "numero_departamento" de "departamento" */
...
/* Criação da chave estrangeira que referencia a tupla "numero_projeto" de "trabalha_em" à tupla "numero_projeto" de "projeto" */
